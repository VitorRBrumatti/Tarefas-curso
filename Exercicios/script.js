...
function calculoIniciado() {
    ...
    if (imc <= 18.5) {
        textImc.innerText = `Atenção! Você está abaixo do peso seu imc é ${parseInt(imc)}`
    } 
    else if (imc >= 18.6 && imc <= 24.9) {
        textImc.innerText = `Você está com peso normal e seu imc é ${parseInt(imc)}`
    }
    else if (imc >= 25 && imc <= 29.9) {
        textImc.innerText = `Você está com sobrepeso e seu imc é ${parseInt(imc)}`
    }
    else if (imc >= 30 && imc <= 34.9) {
        textImc.innerText = `Você está em Obesidade 1 e seu imc é ${parseInt(imc)}`
    }
    else if (imc >= 35 && imc <= 39.9) {
        textImc.innerText = `Cuidado! Você está em Obesidade 2 e seu imc é ${parseInt(imc)}`
    }
    else if (imc >= 40 ) {
        textImc.innerText = `Atenção! Você está em Obesidade 3!! e seu imc é ${parseInt(imc)}`
    }
    else {
